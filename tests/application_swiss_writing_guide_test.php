...
if (!str_contains($source,'$baseInputParts,$texts,$editTargets') || !str_contains($source,'if ($attempt<3) {')) {
    throw new RuntimeException('Recipient review must use current sources and targeted retry.');
}
