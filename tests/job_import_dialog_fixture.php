...
echo '<form method="post"><input type="hidden" name="csrf" value="test-csrf"><textarea name="import_payload">https://example.test/job-one\nhttps://example.test/job-two</textarea><button name="action" value="preview_import">Vorschlag erstellen</button></form>';
