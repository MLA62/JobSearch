...
performanceCheck(str_contains($source, "runtime_schema_2_4_25"), 'Runtime schema work has a release marker');
...
performanceCheck(str_contains($source, "runtime_maintenance_2_4_25"), 'Seed and data migrations have a combined release marker');
