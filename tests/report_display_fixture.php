...
$columns = ['applied_at', 'match_score', 'status', 'title'];
$headers = ['Bewerbungsdatum', 'Match', 'Status', 'Stelle'];
$rows = [
    ['11.09.2026', '85', 'Gesendet', "Account Manager\nErste Zeile"],
    ['12.09.2026', '65', 'Entwurf', 'Projektleitung <script>alert(1)</script>'],
];
$meta = [
    ['calendar_day'=>'11.09.2026', 'calendar_week'=>'37 / 2026', 'calendar_month'=>'09/2026', 'record_url'=>'/?page=jobs&edit=11#new', 'filter_values'=>['applied_at'=>'2026-09-11 10:00:00','match_score'=>'85','status'=>'sent','title'=>'Account Manager']],
    ['calendar_day'=>'12.09.2026', 'calendar_week'=>'37 / 2026', 'calendar_month'=>'09/2026', 'record_url'=>'/?page=jobs&edit=12#new', 'filter_values'=>['applied_at'=>'2026-09-12 10:00:00','match_score'=>'65','status'=>'draft','title'=>'Projektleitung']],
];
