...
<?php else: requireLogin(); ?>
    ...
    <?php elseif ($page === 'jobs'): ?>
        ...
        <div class="split"><section class="panel" id="new"><h2><?= e($edit ? tr('jobs.edit') : ($draft ? tr('jobs.check_import') : tr('jobs.create'))) ?></h2><form method="post" class="stack">
            ...
            <label><?= e(tr('jobs.source_url')) ?><input type="url" name="source_url" value="<?= e($form['source_url'] ?? '') ?>"><?php if(!empty($form['source_url'])): ?><small class="actions"><a href="<?= e($form['source_url']) ?>" target="_blank" rel="noopener"><?= e(tr('jobs.open_source_url')) ?></a><?php if($edit): ?><button class="primary-link" name="action" value="queue_job_original_pdf" formnovalidate><?= e(tr('dossier.create_pdf')) ?></button><?php if(!empty($edit['original_document_id'])): ?><a href="/?page=document_download&id=<?= (int)$edit['original_document_id'] ?>" target="_blank" rel="noopener"><?= e(tr('jobs.original_pdf')) ?></a><?php endif; ?><?php endif; ?></small><?php endif; ?></label><label><?= e(tr('common.description')) ?><textarea name="description" rows="6"><?= e($form['description'] ?? '') ?></textarea></label><label><?= e(tr('common.comment')) ?><textarea name="job_notes" rows="4"><?= e($form['notes'] ?? '') ?></textarea></label>
