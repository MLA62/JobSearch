...
function legacyUiSupplementalTranslationCatalog(): array
{
    return [
        'fr-CH' => [
            ...
            'Ansicht' => 'Vue',
            'Filter' => 'Filtre',
            'Filtertext' => 'Texte de filtre',
            'Text in allen Spalten' => 'Texte dans toutes les colonnes',
            'Sort' => 'Tri',
            ...
            'Adresse' => 'Adresse',
            'Strasse und Nummer' => 'Rue et numéro',
            'Adresszusatz' => 'Complément d’adresse',
            'PLZ' => 'NPA',
            'Region' => 'Région',
            'Land' => 'Pays',
            'Ergibt sich aus Region' => 'Déduit de la région',
            'Möglicher Vermittler / Personalvermittler' => 'Intermédiaire / recruteur possible',
            'Direkte Firma / keine Vermittlung erfasst' => 'Entreprise directe / aucune intermédiation saisie',
            'Sprachkenntnisse' => 'Compétences linguistiques',
            'Niveau' => 'Niveau',
            'A1 Anfänger' => 'A1 Débutant',
            'A2 Grundlagen' => 'A2 Bases',
            'B1 Mittelstufe' => 'B1 Intermédiaire',
            'B2 Selbständig' => 'B2 Autonome',
            'C1 Fachkundig' => 'C1 Avancé',
            'C2 Muttersprache' => 'C2 Langue maternelle',
            'Noch keine Sprachkenntnisse erfasst.' => 'Aucune compétence linguistique saisie.',
            'Job-Referenzen' => 'Préférences d’emploi',
            'Diese Angaben steuern später Matching, Listen und Vorschläge.' => 'Ces données pilotent ensuite le matching, les listes et les propositions.',
            'Vorschläge' => 'propositions',
            'Level / Lage' => 'Niveau / situation',
            'Arbeitsmodell' => 'Modèle de travail',
            'Stellenarten' => 'Types d’emploi',
            ...
            'Reiseanteil max. %' => 'Déplacements max. %',
            'Notizen zu Job-Referenzen' => 'Notes sur les préférences d’emploi',
            'Profil speichern' => 'Enregistrer le profil',
            'z. B. Einstieg, Fachkraft, Teamleitung' => 'p. ex. débutant, spécialiste, chef d’équipe',
            'Egal' => 'Peu importe',
            'Vor Ort' => 'Sur site',
            'Hybrid' => 'Hybride',
            'Remote' => 'À distance',
            ...
            'Karten' => 'Cartes',
            'Vorschau' => 'Aperçu',
            'Kalendertag' => 'Jour calendrier',
            'Kalenderwoche' => 'Semaine calendrier',
            'Kalendermonat' => 'Mois calendrier',
            'Spalten' => 'Colonnes',
            'Report-Name' => 'Nom du rapport',
            'Report-Beschreibung' => 'Description du rapport',
        ],
        'en-GB' => [
            'Name' => 'Name',
            'Basis' => 'Base',
            ...
            'Text in allen Spalten' => 'Text in all columns',
            'Sort' => 'Sort',
            ...
            'Direkte Firma / keine Vermittlung erfasst' => 'Direct company / no intermediary recorded',
            'Sprachkenntnisse' => 'Language skills',
            'Niveau' => 'Level',
            'A1 Anfänger' => 'A1 Beginner',
            'A2 Grundlagen' => 'A2 Elementary',
            'B1 Mittelstufe' => 'B1 Intermediate',
            'B2 Selbständig' => 'B2 Independent',
            'C1 Fachkundig' => 'C1 Advanced',
            'C2 Muttersprache' => 'C2 Native speaker',
            'Noch keine Sprachkenntnisse erfasst.' => 'No language skills recorded yet.',
            'Job-Referenzen' => 'Job preferences',
            'Diese Angaben steuern später Matching, Listen und Vorschläge.' => 'These details later control matching, lists and suggestions.',
            'Vorschläge' => 'suggestions',
            'Level / Lage' => 'Level / situation',
            'Arbeitsmodell' => 'Work model',
            'Stellenarten' => 'Employment types',
            'Vollzeit' => 'Full-time',
            'Teilzeit' => 'Part-time',
            'Temporär' => 'Temporary',
            ...
            'Freelance' => 'Freelance',
            'Pensum min. %' => 'Workload min. %',
            'Pensum max. %' => 'Workload max. %',
            'PK / Extras / Benefits' => 'Pension / extras / benefits',
            'Umzug möglich' => 'Relocation possible',
            'Reiseanteil max. %' => 'Travel max. %',
            'Notizen zu Job-Referenzen' => 'Notes on job preferences',
            'Profil speichern' => 'Save profile',
            'z. B. Einstieg, Fachkraft, Teamleitung' => 'e.g. entry level, specialist, team lead',
            'Egal' => 'Any',
            'Vor Ort' => 'On-site',
            'Hybrid' => 'Hybrid',
            'Remote' => 'Remote',
            ...
            'Report-Beschreibung' => 'Report description',
        ],
        'pt-BR' => [
            'Name' => 'Nome',
            'Basis' => 'Base',
            ...
            'Filter' => 'Filtro',
            'Filtertext' => 'Texto do filtro',
            'Text in allen Spalten' => 'Texto em todas as colunas',
            'Sort' => 'Ordenar',
            ...
            'Adresse' => 'Endereço',
            'Strasse und Nummer' => 'Rua e número',
            'Adresszusatz' => 'Complemento de endereço',
            'PLZ' => 'CEP',
            'Region' => 'Região',
            'Land' => 'País',
            'Ergibt sich aus Region' => 'Derivado da região',
            'Möglicher Vermittler / Personalvermittler' => 'Possível intermediário / recrutador',
            'Direkte Firma / keine Vermittlung erfasst' => 'Empresa direta / nenhuma intermediação registrada',
            'Sprachkenntnisse' => 'Idiomas',
            'Niveau' => 'Nível',
            'A1 Anfänger' => 'A1 Iniciante',
            'A2 Grundlagen' => 'A2 Básico',
            'B1 Mittelstufe' => 'B1 Intermediário',
            'B2 Selbständig' => 'B2 Independente',
            'C1 Fachkundig' => 'C1 Avançado',
            'C2 Muttersprache' => 'C2 Nativo',
            'Noch keine Sprachkenntnisse erfasst.' => 'Ainda não há idiomas registrados.',
            'Job-Referenzen' => 'Preferências de vagas',
            'Diese Angaben steuern später Matching, Listen und Vorschläge.' => 'Esses dados depois controlam matching, listas e sugestões.',
            'Vorschläge' => 'sugestões',
            'Level / Lage' => 'Nível / situação',
            ...
            'Praktikum' => 'Estágio',
            'Freelance' => 'Freelance',
            'Pensum min. %' => 'Carga mín. %',
            'Pensum max. %' => 'Carga máx. %',
            'PK / Extras / Benefits' => 'Previdência / extras / benefícios',
            'Umzug möglich' => 'Mudança possível',
            'Reiseanteil max. %' => 'Viagens máx. %',
            'Notizen zu Job-Referenzen' => 'Notas sobre preferências de vagas',
            'Profil speichern' => 'Salvar perfil',
            'z. B. Einstieg, Fachkraft, Teamleitung' => 'ex.: inicial, especialista, liderança de equipe',
            'Egal' => 'Qualquer',
            'Vor Ort' => 'Presencial',
            'Hybrid' => 'Híbrido',
            'Remote' => 'Remoto',
            ...
            'Karten' => 'Cartões',
            'Vorschau' => 'Prévia',
            'Kalendertag' => 'Dia do calendário',
            'Kalenderwoche' => 'Semana do calendário',
            'Kalendermonat' => 'Mês do calendário',
            'Spalten' => 'Colunas',
            'Report-Name' => 'Nome do relatório',
            'Report-Beschreibung' => 'Descrição do relatório',
        ],
        'es-MX' => [
            'Name' => 'Nombre',
            'Basis' => 'Base',
            ...
            'Text in allen Spalten' => 'Texto en todas las columnas',
            'Sort' => 'Ordenar',
            'Sortieren nach' => 'Ordenar por',
            ...
            'Adresse' => 'Dirección',
            'Strasse und Nummer' => 'Calle y número',
            'Adresszusatz' => 'Complemento de dirección',
            'PLZ' => 'Código postal',
            'Region' => 'Región',
            'Land' => 'País',
            'Ergibt sich aus Region' => 'Derivado de la región',
            'Möglicher Vermittler / Personalvermittler' => 'Posible intermediario / reclutador',
            'Direkte Firma / keine Vermittlung erfasst' => 'Empresa directa / ninguna intermediación registrada',
            'Sprachkenntnisse' => 'Idiomas',
            'Niveau' => 'Nivel',
            'A1 Anfänger' => 'A1 Principiante',
            'A2 Grundlagen' => 'A2 Básico',
            'B1 Mittelstufe' => 'B1 Intermedio',
            'B2 Selbständig' => 'B2 Independiente',
            'C1 Fachkundig' => 'C1 Avanzado',
            'C2 Muttersprache' => 'C2 Nativo',
            'Noch keine Sprachkenntnisse erfasst.' => 'Aún no hay idiomas registrados.',
            'Job-Referenzen' => 'Preferencias de empleo',
            'Diese Angaben steuern später Matching, Listen und Vorschläge.' => 'Estos datos controlan después el matching, las listas y las sugerencias.',
            'Vorschläge' => 'sugerencias',
            'Level / Lage' => 'Nivel / situación',
            'Arbeitsmodell' => 'Modelo de trabajo',
            'Stellenarten' => 'Tipos de empleo',
            'Vollzeit' => 'Tiempo completo',
            'Teilzeit' => 'Medio tiempo',
            'Temporär' => 'Temporal',
            ...
            'Reiseanteil max. %' => 'Viajes máx. %',
            'Notizen zu Job-Referenzen' => 'Notas sobre preferencias de empleo',
            'Profil speichern' => 'Guardar perfil',
            'z. B. Einstieg, Fachkraft, Teamleitung' => 'p. ej. inicial, especialista, liderazgo de equipo',
            'Egal' => 'Cualquiera',
            'Vor Ort' => 'Presencial',
            'Hybrid' => 'Híbrido',
            'Remote' => 'Remoto',
            ...
            'Kalendertag' => 'Día calendario',
            'Kalenderwoche' => 'Semana calendario',
            'Kalendermonat' => 'Mes calendario',
            'Spalten' => 'Columnas',
            'Report-Name' => 'Nombre del reporte',
            'Report-Beschreibung' => 'Descripción del reporte',
        ],
    ];
}
...
function legacyUiQualityPatchTranslationCatalog(): array
{
    return [
        'fr-CH' => [
            'Konto erstellen' => 'Créer le compte',
            'Deine Jobs. Dein Prozess.' => 'Tes emplois. Ton processus.',
            'Nächste Schritte' => 'Prochaines étapes',
            'Erfasse zuerst eine Firma und danach passende Stellen.' => 'Saisis d’abord une entreprise, puis les postes correspondants.',
            'Job erfassen' => 'Saisir un emploi',
            'Datei' => 'Fichier',
            'Planung' => 'Planification',
            'Auswertung' => 'Analyse',
            'Konto' => 'Compte',
            'Kontakt bearbeiten' => 'Modifier le contact',
            'Funktion' => 'Fonction',
            ...
            'Betreff' => 'Objet',
            'Mitteilung' => 'Message',
            'Eintrag speichern' => 'Enregistrer l’entrée',
            'Job bearbeiten' => 'Modifier l’emploi',
            'Jobtitel' => 'Titre du poste',
            'Gesendet' => 'Envoyé',
            'Onlinebewerbung' => 'Candidature en ligne',
            'Ziehe die vorbereiteten Dateien per Drag & Drop ins Onlineformular.' => 'Glisse les fichiers préparés dans le formulaire en ligne.',
            'Temporären Unterlagenordner öffnen' => 'Ouvrir le dossier temporaire des documents',
            'Kalender / Erinnerungen' => 'Calendrier / rappels',
            'Tagesplan' => 'Plan du jour',
            'Wochenplan' => 'Plan hebdomadaire',
            'Monatsplan' => 'Plan mensuel',
            'Erlaube ADMIN Support nur, wenn ein Administrator deine Umgebung 1:1 sehen und bedienen soll.' => 'Autorise le support ADMIN uniquement si un administrateur doit voir et utiliser ton environnement 1:1.',
            'Hilfe durchsuchen' => 'Rechercher dans l’aide',
            'Jobsuche' => 'Recherche d’emploi',
            'Lizenz' => 'Licence',
            'z. B. Onlinebewerbung, Kontaktlog, PDF, Support' => 'p. ex. candidature en ligne, journal de contact, PDF, support',
            'Übersicht' => 'Vue d’ensemble',
            'Die Übersicht zeigt den aktuellen Stand deiner Jobs, Bewerbungen, Pendenten und nächsten Schritte.' => 'La vue d’ensemble affiche l’état actuel de tes emplois, candidatures, éléments en suspens et prochaines étapes.',
            'Wie vorgehen' => 'Comment procéder',
            'Ausführliche Hilfe öffnen' => 'Ouvrir l’aide détaillée',
        ...
        'en-GB' => [
            ...
            'Deine Jobs. Dein Prozess.' => 'Your jobs. Your process.',
            'Nächste Schritte' => 'Next steps',
            'Erfasse zuerst eine Firma und danach passende Stellen.' => 'Create a company first, then add matching jobs.',
            'Job erfassen' => 'Add job',
            'Datei' => 'File',
            'Planung' => 'Planning',
            ...
            'Job bearbeiten' => 'Edit job',
            'Jobtitel' => 'Job title',
            'Gesendet' => 'Sent',
            'Onlinebewerbung' => 'Online application',
            'Ziehe die vorbereiteten Dateien per Drag & Drop ins Onlineformular.' => 'Drag the prepared files into the online form.',
            'Temporären Unterlagenordner öffnen' => 'Open temporary document folder',
            'Kalender / Erinnerungen' => 'Calendar / reminders',
            'Tagesplan' => 'Day plan',
            'Wochenplan' => 'Week plan',
            'Monatsplan' => 'Month plan',
            'Erlaube ADMIN Support nur, wenn ein Administrator deine Umgebung 1:1 sehen und bedienen soll.' => 'Allow ADMIN support only if an administrator should see and operate your environment 1:1.',
            'Hilfe durchsuchen' => 'Search help',
            'Jobsuche' => 'Job search',
            'Lizenz' => 'Licence',
            'z. B. Onlinebewerbung, Kontaktlog, PDF, Support' => 'e.g. online application, contact log, PDF, support',
            'Übersicht' => 'Overview',
            'Die Übersicht zeigt den aktuellen Stand deiner Jobs, Bewerbungen, Pendenten und nächsten Schritte.' => 'The overview shows the current state of your jobs, applications, pending items and next steps.',
            'Wie vorgehen' => 'How to proceed',
            'Ausführliche Hilfe öffnen' => 'Open detailed help',
        ...
        'pt-BR' => [
            ...
            'Deine Jobs. Dein Prozess.' => 'Suas vagas. Seu processo.',
            'Nächste Schritte' => 'Próximos passos',
            'Erfasse zuerst eine Firma und danach passende Stellen.' => 'Cadastre primeiro uma empresa e depois as vagas correspondentes.',
            'Job erfassen' => 'Cadastrar vaga',
            'Datei' => 'Arquivo',
            'Planung' => 'Planejamento',
            'Auswertung' => 'Relatórios',
            'Konto' => 'Conta',
            'Kontakt bearbeiten' => 'Editar contato',
            'Funktion' => 'Função',
            'Abteilung' => 'Departamento',
            'Datum/Uhrzeit' => 'Data/hora',
            'Wiedervorlage' => 'Retorno',
            'Betreff' => 'Assunto',
            'Mitteilung' => 'Mensagem',
            'Eintrag speichern' => 'Salvar entrada',
            'Job bearbeiten' => 'Editar vaga',
            'Jobtitel' => 'Título da vaga',
            'Gesendet' => 'Enviado',
            'Onlinebewerbung' => 'Candidatura on-line',
            'Ziehe die vorbereiteten Dateien per Drag & Drop ins Onlineformular.' => 'Arraste os arquivos preparados para o formulário on-line.',
            'Temporären Unterlagenordner öffnen' => 'Abrir pasta temporária de documentos',
            'Kalender / Erinnerungen' => 'Calendário / lembretes',
            'Tagesplan' => 'Plano diário',
            'Wochenplan' => 'Plano semanal',
            'Monatsplan' => 'Plano mensal',
            'Erlaube ADMIN Support nur, wenn ein Administrator deine Umgebung 1:1 sehen und bedienen soll.' => 'Permita suporte ADMIN apenas se um administrador deve ver e operar seu ambiente 1:1.',
            'Hilfe durchsuchen' => 'Pesquisar ajuda',
            'Jobsuche' => 'Busca de vagas',
            'Lizenz' => 'Licença',
            'z. B. Onlinebewerbung, Kontaktlog, PDF, Support' => 'ex.: candidatura on-line, registro de contato, PDF, suporte',
            'Übersicht' => 'Visão geral',
            'Die Übersicht zeigt den aktuellen Stand deiner Jobs, Bewerbungen, Pendenten und nächsten Schritte.' => 'A visão geral mostra o estado atual das suas vagas, candidaturas, pendências e próximos passos.',
            'Wie vorgehen' => 'Como proceder',
            'Ausführliche Hilfe öffnen' => 'Abrir ajuda detalhada',
        ...
        'es-MX' => [
            ...
            'Deine Jobs. Dein Prozess.' => 'Tus empleos. Tu proceso.',
            'Nächste Schritte' => 'Siguientes pasos',
            'Erfasse zuerst eine Firma und danach passende Stellen.' => 'Registra primero una empresa y después los empleos correspondientes.',
            'Job erfassen' => 'Registrar empleo',
            'Datei' => 'Archivo',
            'Planung' => 'Planificación',
            'Auswertung' => 'Reportes',
            'Konto' => 'Cuenta',
            'Kontakt bearbeiten' => 'Editar contacto',
            'Funktion' => 'Función',
            'Abteilung' => 'Departamento',
            'Datum/Uhrzeit' => 'Fecha/hora',
            'Wiedervorlage' => 'Seguimiento',
            'Betreff' => 'Asunto',
            'Mitteilung' => 'Mensaje',
            'Eintrag speichern' => 'Guardar entrada',
            'Job bearbeiten' => 'Editar empleo',
            'Jobtitel' => 'Título del empleo',
            'Gesendet' => 'Enviado',
            'Onlinebewerbung' => 'Postulación en línea',
            'Ziehe die vorbereiteten Dateien per Drag & Drop ins Onlineformular.' => 'Arrastra los archivos preparados al formulario en línea.',
            'Temporären Unterlagenordner öffnen' => 'Abrir carpeta temporal de documentos',
            'Kalender / Erinnerungen' => 'Calendario / recordatorios',
            'Tagesplan' => 'Plan diario',
            'Wochenplan' => 'Plan semanal',
            'Monatsplan' => 'Plan mensual',
            'Erlaube ADMIN Support nur, wenn ein Administrator deine Umgebung 1:1 sehen und bedienen soll.' => 'Permite soporte ADMIN solo si un administrador debe ver y operar tu entorno 1:1.',
            'Hilfe durchsuchen' => 'Buscar ayuda',
            'Jobsuche' => 'Búsqueda de empleo',
            'Lizenz' => 'Licencia',
            'z. B. Onlinebewerbung, Kontaktlog, PDF, Support' => 'p. ej. postulación en línea, registro de contacto, PDF, soporte',
            'Übersicht' => 'Resumen',
            'Die Übersicht zeigt den aktuellen Stand deiner Jobs, Bewerbungen, Pendenten und nächsten Schritte.' => 'El resumen muestra el estado actual de tus empleos, postulaciones, pendientes y siguientes pasos.',
            'Wie vorgehen' => 'Cómo proceder',
            'Ausführliche Hilfe öffnen' => 'Abrir ayuda detallada',
...
function legacyUiTranslationCatalog(): array
{
    ...
    foreach (legacyUiSupplementalTranslationCatalog() as $locale => $terms) {
        $catalog[$locale] = array_replace((array) ($catalog[$locale] ?? []), $terms);
    }
    foreach (legacyUiQualityPatchTranslationCatalog() as $locale => $terms) {
        $catalog[$locale] = array_replace((array) ($catalog[$locale] ?? []), $terms);
    }
    return $catalog;
}
