...
try {
    ...
    foreach ([
        ...
        'companies.direct_none' => [
            'de-CH' => 'Direkt', 'fr-CH' => 'Direct', 'en-GB' => 'Direct',
            'pt-BR' => 'Direto', 'es-MX' => 'Directo',
        ],
        'applications.job_room_registration' => [
            'de-CH' => 'Erfassung im Job-Room', 'fr-CH' => 'Saisie dans Job-Room', 'en-GB' => 'Job-Room registration',
            'pt-BR' => 'Registro no Job-Room', 'es-MX' => 'Registro en Job-Room',
        ],
        'applications.job_room_not_recorded' => [
            'de-CH' => 'Noch nicht im Job-Room erfasst', 'fr-CH' => 'Pas encore saisi dans Job-Room', 'en-GB' => 'Not yet recorded in Job-Room',
            'pt-BR' => 'Ainda não registrado no Job-Room', 'es-MX' => 'Todavía no registrado en Job-Room',
        ],
        ...
        'applications.job_room_unknown' => [
            ...
            'pt-BR' => 'Registro não confirmado', 'es-MX' => 'Registro no confirmado',
        ],
        'applications.status.interview' => [
            'de-CH' => 'Bewerbungsgespräche',
            'fr-CH' => 'Entretiens d’embauche',
            'en-GB' => 'Interviews',
            'pt-BR' => 'Entrevistas',
            'es-MX' => 'Entrevistas',
        ],
        'calendar.application_sent' => [
            'de-CH' => 'Bewerbung gesendet',
            'fr-CH' => 'Candidature envoyée',
        ...
        'contacts.activity_counts' => [
            'de-CH'=>'Kontakt-Log: {total} Einträge, davon {open} offen/geplant',
            'fr-CH'=>'Journal du contact : {total} entrées, dont {open} ouvertes/planifiées',
            'en-GB'=>'Contact log: {total} entries, {open} open/planned',
            'pt-BR'=>'Histórico do contato: {total} registros, {open} abertos/planejados',
            'es-MX'=>'Registro del contacto: {total} entradas, {open} abiertas/programadas',
        ],
        ...
        'applications.next_action' => [
            ...
            'fr-CH' => 'Prochain événement',
            'en-GB' => 'Next calendar entry',
            'pt-BR' => 'Próximo evento',
            'es-MX' => 'Próximo evento',
        ],
        'applications.calendar_date_required' => [
            'de-CH' => 'Bitte einen Termin für den Kalendereintrag angeben.',
            'fr-CH' => 'Indique une date pour cet événement.',
            'en-GB' => 'Please set a date for this calendar entry.',
            'pt-BR' => 'Informe uma data para este evento.',
            'es-MX' => 'Indica una fecha para este evento.',
        ],
        'applications.status.accepted' => [
            'de-CH'=>'Zusage', 'fr-CH'=>'Réponse positive', 'en-GB'=>'Positive outcome',
            'pt-BR'=>'Resposta positiva', 'es-MX'=>'Respuesta positiva',
        ],
        'jobs.recorded_at' => [
        ...
        'calendar.edit_entry' => [
            'de-CH' => 'Termin bearbeiten', 'fr-CH' => 'Modifier le rendez-vous', 'en-GB' => 'Edit appointment', 'pt-BR' => 'Editar compromisso', 'es-MX' => 'Editar cita',
        ],
        'calendar.delete_confirm' => [
            'de-CH' => 'Diesen Termin löschen?', 'fr-CH' => 'Supprimer ce rendez-vous ?', 'en-GB' => 'Delete this appointment?', 'pt-BR' => 'Excluir este compromisso?', 'es-MX' => '¿Eliminar esta cita?',
        ],
        'flash.calendar.deleted' => [
            'de-CH' => 'Termin gelöscht.', 'fr-CH' => 'Rendez-vous supprimé.', 'en-GB' => 'Appointment deleted.', 'pt-BR' => 'Compromisso excluído.', 'es-MX' => 'Cita eliminada.',
        ],
        'calendar.end' => [
            'de-CH' => 'Ende', 'fr-CH' => 'Fin', 'en-GB' => 'End', 'pt-BR' => 'Fim', 'es-MX' => 'Fin',
        ],
        'calendar.location' => [
            'de-CH' => 'Ort', 'fr-CH' => 'Lieu', 'en-GB' => 'Location', 'pt-BR' => 'Local', 'es-MX' => 'Lugar',
        ],
        'bulk.select_all' => [
        ...
        'bulk.delete_confirm' => [
            'de-CH' => 'Ausgewählte Datensätze löschen?', 'fr-CH' => 'Supprimer les enregistrements sélectionnés ?', 'en-GB' => 'Delete the selected records?', 'pt-BR' => 'Excluir os registros selecionados?', 'es-MX' => '¿Eliminar los registros seleccionados?',
        ],
        'bulk.deleting' => [
            'de-CH' => 'Löschen...', 'fr-CH' => 'Suppression...', 'en-GB' => 'Deleting...', 'pt-BR' => 'Excluindo...', 'es-MX' => 'Eliminando...',
        ],
        'flash.contacts.deleted' => [
            'de-CH' => 'Kontakt gelöscht.', 'fr-CH' => 'Contact supprimé.', 'en-GB' => 'Contact deleted.', 'pt-BR' => 'Contato excluído.', 'es-MX' => 'Contacto eliminado.',
        ],
        ...
        'calendar.google_config_hint' => [
            'de-CH' => 'Verbinde dein Google-Konto direkt bei Google. Anschliessend werden deine Termine mit dem gewählten Kalender synchronisiert.',
            'fr-CH' => 'Connecte ton compte Google directement auprès de Google. Tes rendez-vous seront ensuite synchronisés avec le calendrier choisi.',
            'en-GB' => 'Connect your Google account directly with Google. Your appointments will then sync with the selected calendar.',
            'pt-BR' => 'Conecte sua conta do Google diretamente no Google. Seus compromissos serão sincronizados com o calendário selecionado.',
            'es-MX' => 'Conecta tu cuenta de Google directamente con Google. Tus citas se sincronizarán con el calendario seleccionado.',
        ],
        ...
        'calendar.google_save' => [
            'de-CH' => 'Kalender speichern',
            'fr-CH' => 'Enregistrer le calendrier',
            'en-GB' => 'Save calendar',
            'pt-BR' => 'Salvar calendário',
            'es-MX' => 'Guardar calendario',
        ],
        ...
        'flash.google_calendar.credentials_required' => [
            'de-CH' => 'Die Google-Verbindung ist noch nicht verfügbar. Bitte versuche es später erneut.',
            'fr-CH' => 'La connexion Google n’est pas encore disponible. Réessaie plus tard.',
            'en-GB' => 'The Google connection is not available yet. Please try again later.',
            'pt-BR' => 'A conexão com o Google ainda não está disponível. Tente novamente mais tarde.',
            'es-MX' => 'La conexión con Google aún no está disponible. Inténtalo de nuevo más tarde.',
        ],
        ...
        'profile.desired_roles' => [
            ...
            'en-GB' => 'Desired roles',
            'pt-BR' => 'Funções desejadas',
            'es-MX' => 'Puestos deseados',
        ],
        'profile.desired_roles_placeholder' => [
            'de-CH' => 'Zum Beispiel Vertrieb, Beratung, Projektleitung',
            'fr-CH' => 'Par exemple vente, conseil, gestion de projet',
            'en-GB' => 'For example sales, consulting, project management',
            'pt-BR' => 'Por exemplo vendas, consultoria, gestão de projetos',
            'es-MX' => 'Por ejemplo ventas, consultoría, gestión de proyectos',
        ],
        'profile.desired_locations' => [
            'de-CH' => 'Gewünschte Arbeitsorte',
            'fr-CH' => 'Lieux de travail souhaités',
            'en-GB' => 'Desired locations',
            'pt-BR' => 'Locais de trabalho desejados',
            'es-MX' => 'Lugares de trabajo deseados',
        ],
        'profile.desired_locations_placeholder' => [
            'de-CH' => 'Orte oder Regionen',
            'fr-CH' => 'Villes ou régions',
            'en-GB' => 'Towns or regions',
            'pt-BR' => 'Cidades ou regiões',
            'es-MX' => 'Ciudades o regiones',
        ],
        'profile.remote_preference' => [
            'de-CH' => 'Arbeitsmodell',
            'fr-CH' => 'Mode de travail',
            'en-GB' => 'Work arrangement',
            'pt-BR' => 'Modelo de trabalho',
            'es-MX' => 'Modalidad de trabajo',
        ],
        'profile.remote.any' => [
            'de-CH' => 'Keine Präferenz',
            'fr-CH' => 'Sans préférence',
            'en-GB' => 'No preference',
            'pt-BR' => 'Sem preferência',
            'es-MX' => 'Sin preferencia',
        ],
        'profile.remote.onsite' => [
            'de-CH' => 'Nur vor Ort',
            'fr-CH' => 'Uniquement sur site',
            'en-GB' => 'Onsite only',
            'pt-BR' => 'Somente presencial',
            'es-MX' => 'Solo presencial',
        ],
        ...
        'profile.remote.remote' => [
            'de-CH' => 'Nur remote',
            'fr-CH' => 'Uniquement à distance',
            'en-GB' => 'Remote only',
            'pt-BR' => 'Somente remoto',
            'es-MX' => 'Solo remoto',
        ],
        'profile.employment_types' => [
            'de-CH' => 'Anstellungsarten',
            'fr-CH' => 'Types de contrat',
            'en-GB' => 'Employment types',
            'pt-BR' => 'Tipos de contratação',
            'es-MX' => 'Tipos de contratación',
        ],
        'profile.employment.full_time' => [
            'de-CH' => 'Vollzeit',
            'fr-CH' => 'Temps plein',
            'en-GB' => 'Full-time',
        ...
        'profile.employment.part_time' => [
            'de-CH' => 'Teilzeit',
            'fr-CH' => 'Temps partiel',
            'en-GB' => 'Part-time',
            'pt-BR' => 'Meio período',
            'es-MX' => 'Tiempo parcial',
        ],
        'profile.employment.temporary' => [
            'de-CH' => 'Temporär',
            'fr-CH' => 'Temporaire',
            'en-GB' => 'Temporary',
            'pt-BR' => 'Temporário',
        ...
        'profile.employment.contract' => [
            'de-CH' => 'Befristet',
            'fr-CH' => 'Durée déterminée',
            'en-GB' => 'Fixed-term',
            'pt-BR' => 'Prazo determinado',
            'es-MX' => 'Plazo fijo',
        ],
        'profile.employment.internship' => [
            'de-CH' => 'Praktikum',
            'fr-CH' => 'Stage',
            'en-GB' => 'Internship',
            'pt-BR' => 'Estágio',
        ...
        'profile.workload_min' => [
            ...
            'en-GB' => 'Minimum workload (%)',
            'pt-BR' => 'Carga de trabalho mínima (%)',
            'es-MX' => 'Carga de trabajo mínima (%)',
        ],
        'profile.workload_max' => [
            'de-CH' => 'Pensum bis (%)',
            'fr-CH' => 'Taux d’activité maximum (%)',
            'en-GB' => 'Maximum workload (%)',
            'pt-BR' => 'Carga de trabalho máxima (%)',
            'es-MX' => 'Carga de trabajo máxima (%)',
        ],
        'profile.salary' => [
            'de-CH' => 'Lohnvorstellung',
            'fr-CH' => 'Salaire souhaité',
            'en-GB' => 'Desired salary',
            'pt-BR' => 'Pretensão salarial',
            'es-MX' => 'Sueldo deseado',
        ],
        'profile.salary_format' => [
            'de-CH' => 'Lohnperiode',
            'fr-CH' => 'Période de rémunération',
            'en-GB' => 'Salary period',
            'pt-BR' => 'Período de remuneração',
            'es-MX' => 'Periodo de remuneración',
        ],
        'profile.salary.hour' => [
            'de-CH' => 'Pro Stunde',
            'fr-CH' => 'Par heure',
        ...
        'profile.available_from' => [
            'de-CH' => 'Verfügbar ab',
            'fr-CH' => 'Disponible dès',
            'en-GB' => 'Available from',
            'pt-BR' => 'Disponível a partir de',
            'es-MX' => 'Disponible a partir de',
        ],
        'profile.desired_benefits' => [
            'de-CH' => 'Gewünschte Zusatzleistungen',
            'fr-CH' => 'Avantages souhaités',
            'en-GB' => 'Desired benefits',
            'pt-BR' => 'Benefícios desejados',
            'es-MX' => 'Prestaciones deseadas',
        ],
        'profile.desired_benefits_placeholder' => [
            'de-CH' => 'Zum Beispiel Ferien, Pensionskasse, Weiterbildung',
            'fr-CH' => 'Par exemple vacances, prévoyance, formation continue',
            'en-GB' => 'For example holidays, pension, professional development',
            'pt-BR' => 'Por exemplo férias, previdência, capacitação',
            'es-MX' => 'Por ejemplo vacaciones, pensión, capacitación',
        ],
        'profile.exclusions' => [
            'de-CH' => 'Ausschlüsse',
            'fr-CH' => 'Exclusions',
        ...
        'profile.exclusions_placeholder' => [
            'de-CH' => 'Nicht gewünschte Branchen oder Arbeitsbedingungen',
            'fr-CH' => 'Secteurs ou conditions de travail à exclure',
            'en-GB' => 'Industries or working conditions to exclude',
            'pt-BR' => 'Setores ou condições de trabalho a excluir',
            'es-MX' => 'Sectores o condiciones laborales a excluir',
        ],
        'profile.desired_level' => [
            'de-CH' => 'Gewünschte Funktionsebene',
            'fr-CH' => 'Niveau de responsabilité souhaité',
            'en-GB' => 'Desired seniority',
            'pt-BR' => 'Nível profissional desejado',
            'es-MX' => 'Nivel profesional deseado',
        ],
        'profile.desired_level_placeholder' => [
            'de-CH' => 'Zum Beispiel Fachperson oder Führungskraft',
            'fr-CH' => 'Par exemple spécialiste ou cadre',
            'en-GB' => 'For example specialist or manager',
            'pt-BR' => 'Por exemplo especialista ou gerente',
            'es-MX' => 'Por ejemplo especialista o gerente',
        ],
        'profile.willing_to_relocate' => [
            'de-CH' => 'Umzugsbereit',
            'fr-CH' => 'Disposé à déménager',
            'en-GB' => 'Willing to relocate',
            'pt-BR' => 'Disponível para mudança',
            'es-MX' => 'Disponibilidad para mudarse',
        ],
        'profile.travel_percentage' => [
            'de-CH' => 'Reisebereitschaft (%)',
            'fr-CH' => 'Disponibilité pour voyager (%)',
            'en-GB' => 'Willingness to travel (%)',
            'pt-BR' => 'Disponibilidade para viagens (%)',
            'es-MX' => 'Disponibilidad para viajar (%)',
        ],
        'profile.preference_notes' => [
            'de-CH' => 'Weitere Wünsche',
            'fr-CH' => 'Autres souhaits',
            'en-GB' => 'Additional preferences',
            'pt-BR' => 'Outras preferências',
            'es-MX' => 'Otras preferencias',
        ],
        'profile.job_preferences_title' => [
            'de-CH' => 'Stellenwünsche',
            'fr-CH' => 'Préférences professionnelles',
            'en-GB' => 'Job preferences',
            'pt-BR' => 'Preferências profissionais',
            'es-MX' => 'Preferencias laborales',
        ],
        'profile.job_preferences_hint' => [
            'de-CH' => 'Gewünschte Tätigkeiten und Arbeitsbedingungen',
            'fr-CH' => 'Fonctions et conditions de travail souhaitées',
            'en-GB' => 'Desired roles and working conditions',
            'pt-BR' => 'Funções e condições de trabalho desejadas',
            'es-MX' => 'Puestos y condiciones laborales deseados',
        ],
        'profile.app_language' => [
            'de-CH' => 'App-Sprache',
            'fr-CH' => 'Langue de l’application',
            'en-GB' => 'App language',
            'pt-BR' => 'Idioma do aplicativo',
            'es-MX' => 'Idioma de la aplicación',
        ],
        'profile.app_language_hint' => [
            'de-CH' => 'Die gewählte Sprache gilt für die gesamte App.',
            'fr-CH' => 'La langue sélectionnée s’applique à toute l’application.',
            'en-GB' => 'The selected language applies throughout the app.',
            'pt-BR' => 'O idioma selecionado se aplica a todo o aplicativo.',
            'es-MX' => 'El idioma seleccionado se aplica a toda la aplicación.',
        ],
        'profile.save_profile' => [
            'de-CH' => 'Profil speichern',
            'fr-CH' => 'Enregistrer le profil',
            'en-GB' => 'Save profile',
            'pt-BR' => 'Salvar perfil',
            'es-MX' => 'Guardar perfil',
        ],
        'jobs.workplace.onsite' => [
            'de-CH' => 'Vor Ort',
            'fr-CH' => 'Sur site',
            'en-GB' => 'Onsite',
            'pt-BR' => 'Presencial',
...
function helpTranslationSeeds(): array
{
  ...
  array (
    ...
    'es-MX' => 'La importación rápida de una o varias URL e Importar comparten investigación. El texto original mantiene su idioma. El sitio vinculado de la empresa y hasta tres páginas de contacto/aviso legal/equipo pueden aportar direcciones y contactos de reclutamiento comprobados. Se buscan empresas, contactos y vacantes propios existentes; solo se completan campos vacíos. Se conservan valores, notas, estado y documentos; una empresa vinculada contradictoria requiere revisión. Se recalcula la compatibilidad. Una vacante disponible importada voluntariamente puede tener baja compatibilidad sin aparecer en sugerencias. El texto libre sigue siendo un borrador.',
  ),
...
function sfApplySql(array $state, array $fields, string &$types, array &$values): string
{
    ...
    foreach ((array) ($state['filters'] ?? []) as $field => $filter) {
        ...
        $expr = (string) ($fields[$field]['filter_expr'] ?? $fields[$field]['expr'] ?? '');
        if ($expr === '') {
            continue;
        }
...
function calendarEventRows(mysqli $db, int $userId, DateTimeImmutable $start, DateTimeImmutable $end): array
{
    ...
    foreach (dbAll($db, "SELECT ce.id, ce.title, ce.event_type, ce.entry_kind, ce.source_type, ce.source_id, ce.source_key, ce.starts_at, ce.ends_at, ce.all_day, ce.location, ce.status, ce.notes, ce.application_id, ce.contact_id, a.applied_at, a.status application_status, h.new_status workflow_status, j.title job_title, c.name company_name, ct.first_name, ct.last_name
        ...
        if (in_array($sourceType, ['application_status', 'application_submission'], true)) {
            ...
            $title = $workflowStatus === 'sent' ? tr('calendar.application_sent') : $status;
        ...
        $rows[] = [
            ...
            'workflow_status' => (string)($event['workflow_status'] ?? $event['source_key'] ?? ''),
    ...
    return calendarExportRows($rows);
}
...
{
    return dbOne($db, 'SELECT user_id, calendar_id, calendar_summary, access_token_encrypted, refresh_token_encrypted, token_expires_at, sync_enabled, last_sync_at, last_error FROM user_google_calendar_settings WHERE user_id=? LIMIT 1', 'i', [$userId]) ?: [];
}

function googleCalendarAppCredentials(array $config): array
{
    return [
        'client_id' => trim((string) ($config['google_calendar_client_id'] ?? '')),
        'client_secret' => trim((string) ($config['google_calendar_client_secret'] ?? '')),
    ];
}
...
function googleCalendarEventPayload(array $config, array $event, array $user): array
{
    ...
    return [
        'summary' => implode(' · ', array_filter([(string)($event['company_name'] ?? ''), (string)$event['title']])),
        'description' => $description,
        'location' => (string)($event['location'] ?? ''),
        'start' => $times['start'],
        'end' => $times['end'],
...
{
    $link = dbOne($db, 'SELECT google_event_id FROM google_calendar_import_links WHERE user_id=? AND calendar_event_id=? LIMIT 1', 'ii', [$userId, (int) $event['id']]);
    if (!$link) {
        return;
    }
    $settings = googleCalendarSettings($db, $userId);
    ...
    $token = googleAccessToken($db, $config, $userId, $settings);
    $calendarId = trim((string) ($settings['calendar_id'] ?? '')) ?: 'primary';
    googleJsonRequest('PATCH', 'https://www.googleapis.com/calendar/v3/calendars/' . rawurlencode($calendarId) . '/events/' . rawurlencode((string) $link['google_event_id']), ['Authorization: Bearer ' . $token], googleImportedCalendarEventPayload($event, $user));
}

function deleteGoogleCalendarEvent(mysqli $db, array $config, int $userId, array $user, int $eventId): void
{
    $link = dbOne($db, 'SELECT google_event_id FROM google_calendar_import_links WHERE user_id=? AND calendar_event_id=? LIMIT 1', 'ii', [$userId, $eventId]);
    if (!$link) {
        $link = dbOne($db, 'SELECT google_event_id FROM google_calendar_event_links WHERE user_id=? AND source_type="calendar" AND source_id=? LIMIT 1', 'ii', [$userId, $eventId]);
    }
...
{
    return ['draft', 'ready', 'sent', 'interview', 'accepted', 'rejected'];
}
...
{
    $raw=json_decode((string)($job['raw_import_data'] ?? ''),true);
    if (($raw['verification']['revision'] ?? 0)===1 && isset($job['match_score'])) {
        $reason=($raw['verification']['locale'] ?? '')===currentLocale() ? (string)($raw['verification']['reason'] ?? '') : '';
        return [(int)$job['match_score'],[$reason!=='' ? $reason : tr('jobs.match_reason.insufficient_data')]];
    }
    return [null,[tr('jobs.match_reason.insufficient_data')]];
}
...
function repairMojibake(string $value): string
{
    ...
    $repaired = $value;
    for ($attempt = 0; $attempt < 2 && preg_match('/(?:Ã.|Â.|â€)/u', $repaired); $attempt++) {
        $candidate = @iconv('UTF-8', 'ISO-8859-1//IGNORE', $repaired);
        if (!is_string($candidate) || $candidate === '' || preg_match('//u', $candidate) !== 1) {
            $candidate = @iconv('UTF-8', 'Windows-1252//IGNORE', $repaired);
        }
        if (!is_string($candidate) || $candidate === '' || preg_match('//u', $candidate) !== 1) {
            break;
        }
...
function importUpsertCompany(mysqli $db, int $uid, string $companyName, array $details = []): int
{
    ...
    $limits = ['address_line1'=>190,'address_line2'=>190,'postal_code'=>30,'city'=>120,'region'=>120,'country_code'=>2,'website'=>500,'phone'=>50,'email'=>254,'legal_name'=>255,'industry'=>150,'employee_count'=>50];
...
function importUpsertContact(mysqli $db, int $uid, int $companyId, int $jobId, array $contact): void
{
    ...
    $existing = dbOne($db, 'SELECT id FROM contacts WHERE owner_user_id=? AND company_id=? AND deleted_at IS NULL AND ((?<>"" AND email=?) OR (?<>"" AND first_name=? AND last_name=? AND (?="" OR COALESCE(TRIM(email),"")=""))) LIMIT 1', 'iissssss', [$uid,$companyId,$email,$email,$first.$last,$first,$last,$email]);
    if ($existing) {
        $contactId=(int)$existing['id'];
        foreach (['first_name'=>$first,'last_name'=>$last,'email'=>$email,'phone'=>$phone,'position'=>$position,'department'=>jobDisplayText((string)($contact['department'] ?? ''),150),'mobile'=>jobDisplayText((string)($contact['mobile'] ?? ''),50),'linkedin_url'=>jobDisplayText((string)($contact['linkedin_url'] ?? ''),500)] as $field=>$value) {
            if ($value==='') continue;
            $stmt=$db->prepare("UPDATE contacts SET `$field`=? WHERE id=? AND owner_user_id=? AND company_id=? AND deleted_at IS NULL AND (`$field` IS NULL OR TRIM(`$field`)=\"\")");
            $stmt->bind_param('siii',$value,$contactId,$uid,$companyId); $stmt->execute();
        }
        return;
    }
    ...
    // Run the same fill-only enrichment for additional fields on a newly created contact.
    if (!empty($contact['department']) || !empty($contact['mobile']) || !empty($contact['linkedin_url'])) importUpsertContact($db,$uid,$companyId,$jobId,$contact);
}
...
function importStoreDraft(mysqli $db, int $uid, array $draft): array
{
    ...
    try {
        ...
        foreach ((array)($draft['job_details'] ?? []) as $field=>$value) {
            if (!in_array($field,jobFactFields()['job'],true)) continue;
            $value=jobFactValue('job',$field,(string)$value);
            if ($value===null) continue;
            $emptyCondition=in_array($field,['workplace_type','contract_term'],true) ? "(`$field` IS NULL OR `$field`=\"\" OR `$field`=\"unknown\")" : "(`$field` IS NULL OR `$field`=\"\")";
            if (in_array($field,['workload_min','workload_max','salary_min','salary_max','published_at','expires_at','fixed_term_start','fixed_term_end'],true)) $emptyCondition="`$field` IS NULL";
            if (!$existing) $emptyCondition='1=1';
            $stmt=$db->prepare("UPDATE jobs SET `$field`=? WHERE id=? AND owner_user_id=? AND deleted_at IS NULL AND $emptyCondition");
            $stmt->bind_param('sii',$value,$jobId,$uid); $stmt->execute();
        }
        if (isset($draft['assessment'])) {
            $raw=json_decode((string)($existing['raw_import_data'] ?? ''),true);
            if (!is_array($raw)) $raw=empty($existing['raw_import_data']) ? [] : ['legacy_raw'=>$existing['raw_import_data']];
            $raw['original_url']=$originalUrl; $raw['source_chain']=$draft['source_chain'] ?? [];
            $raw['verification']=$draft['assessment']; $raw['availability']=$draft['availability'] ?? [];
...
function jobAvailability(string $html, int $now): array
{
    $document=new DOMDocument();
    @$document->loadHTML('<?xml encoding="UTF-8">'.$html,LIBXML_NOERROR | LIBXML_NOWARNING | LIBXML_NONET);
    $xpath=new DOMXPath($document); $schema=[];
    ...
    foreach ($xpath->query('//h1 | //h2 | //title') ?: [] as $node) {
        if (preg_match('~(?:page|seite|pagina|página).{0,30}(?:not found|can.t be found|nicht gefunden|introuvable|no encontrada)|^404\b~iu',trim($node->textContent))) return ['status'=>'unavailable','reason'=>'soft_404','checked_at'=>$now];
    }
    $until=trim((string)($schema['validThrough'] ?? ''));
    $expires=$until!=='' ? strtotime($until.(preg_match('/^\d{4}-\d{2}-\d{2}$/',$until) ? 'T23:59:59Z' : '')) : false;
    if ($expires!==false && $expires<$now) return ['status'=>'expired','reason'=>'validThrough','checked_at'=>$now,'expires_at'=>$expires];
    ...
    return ['status'=>'unknown','reason'=>'no_current_availability_evidence','checked_at'=>$now];
}
...
function companyResearchLinks(string $html, string $base): array
{
    ...
    @$document->loadHTML('<?xml encoding="UTF-8">'.$html,LIBXML_NOERROR | LIBXML_NOWARNING | LIBXML_NONET);
    $links=[];
    foreach ((new DOMXPath($document))->query('//a[@href]') ?: [] as $node) {
        if (!preg_match('~kontakt|contact|impressum|imprint|about us|über uns|equipe|équipe|team|contato|contacto~iu',$node->textContent)) continue;
        $url=importResolveUrl($base,$node->getAttribute('href'));
        if (str_starts_with($url,'https://') && parse_url($url,PHP_URL_HOST)===parse_url($base,PHP_URL_HOST) && $url!==$base) $links[$url]=$url;
    }
...
function importFromUrl(string $url, array &$diagnostic = []): array
{
    ...
    for ($depth=0;$depth<3;$depth++) {
        ...
        if (!$candidates) {
            ...
            $metadata=$draft['structured_job'] ?? []; unset($metadata['description']);
            $draft['research_sources']=[['id'=>'original','url'=>$page['url'],'text'=>$draft['title']."\n".$draft['description']."\n".json_encode($metadata,JSON_THROW_ON_ERROR | JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES)]];
            ...
            if ($website!=='') {
                try {
                    ...
                    $pages=[$companyPage];
                    foreach (companyResearchLinks($companyPage['html'],$companyPage['url']) as $link) {
                        try { $pages[]=importFetchHtml($link); } catch (Throwable) { $draft['import_warnings'][]='Eine Firmenunterseite war nicht lesbar.'; }
                    }
                    foreach ($pages as $index=>$researchPage) {
                        $companyText=readableText($researchPage['html']);
                        // Do not attach an unrelated company's address or staff to this employer.
                        if (stripos($companyText,$draft['company'])===false) continue;
                        if (strlen($companyText)>60000) { $draft['import_warnings'][]='Firmenunterseite überschreitet die Auswertungsgrenze.'; continue; }
                        $draft['research_sources'][]=['id'=>'company_'.$index,'url'=>$researchPage['url'],'text'=>$companyText];
                        $draft['company_details']=array_filter($draft['company_details'])+importCompanyPageDetails($researchPage['html'],$draft['company']);
                    }
                } catch (Throwable) {
...
{
    $criteria['query']=$criteria['query'] ?? ($criteria['search_query'] ?? '');
    $criteria['location']=$criteria['location'] ?? ($criteria['search_location'] ?? '');
    $groups=[
        'roles'=>[35,true,['desired_roles','query']],
        'location'=>[20,true,['desired_locations','location']],
        'workload'=>[15,true,['workload_min','workload_max']],
        'level'=>[10,false,['desired_level']], 'remote'=>[10,false,['remote_preference']],
        'employment'=>[10,false,['employment_types']], 'salary'=>[10,false,['salary_min','salary_period']],
        'benefits'=>[3,false,['desired_benefits']], 'exclusions'=>[15,true,['excluded_industries']],
        'travel'=>[5,false,['travel_percentage']], 'availability'=>[5,false,['available_from']],
        'other'=>[5,false,['preference_notes']],
    ];
    $active=[];
    foreach ($groups as $id=>[$weight,$hard,$keys]) {
        $values=[];
        foreach ($keys as $key) if (isset($criteria[$key]) && trim((string)$criteria[$key])!=='') $values[$key]=(string)$criteria[$key];
        if ($id==='remote' && ($values['remote_preference'] ?? '')==='any') continue;
        if ($id==='salary' && empty($values['salary_min'])) continue;
        if ($values) $active[$id]=['weight'=>$weight,'hard'=>$hard,'values'=>$values];
    }
    return $active;
}
...
function jobEvidenceQuote(array $sources, string $sourceId, string $quote): bool
{
    ...
    if (strlen($quote)<4 || strlen($quote)>1500) return false;
    foreach ($sources as $source) if ($source['id']===$sourceId && str_contains($normalize($source['text']),$quote)) return true;
    return false;
}

function jobEvidenceScore(array $criteria, array $checks, array $sources): array
{
    $active=jobMatchCriteria($criteria); $seen=[]; $earned=0; $possible=0; $reject=false; $reasons=[];
    foreach ($checks as $check) {
        $id=(string)($check['criterion'] ?? '');
        if (!isset($active[$id]) || isset($seen[$id])) throw new RuntimeException('Ungültige oder doppelte Match-Kriterien.');
        $seen[$id]=$check;
    }
    foreach ($active as $id=>$criterion) {
        $check=$seen[$id] ?? ['verdict'=>'unknown']; $verdict=$check['verdict'] ?? 'unknown';
        if (!in_array($verdict,['met','partial','unmet','unknown'],true)) throw new RuntimeException('Ungültiges Match-Ergebnis.');
        // Company marketing is not evidence that this particular vacancy meets a condition.
        if ($verdict!=='unknown' && (($check['source_id'] ?? '')!=='original' || !jobEvidenceQuote($sources,'original',(string)($check['quote'] ?? '')))) $verdict='unknown';
        $possible+=$criterion['weight'];
        $earned+=$criterion['weight']*match($verdict){'met'=>1,'partial'=>0.5,default=>0};
        if ($criterion['hard'] && $verdict==='unmet') $reject=true;
        if (in_array($id,['roles','location'],true) && $verdict==='unknown') $reject=true;
        $reasons[]=['criterion'=>$id,'verdict'=>$verdict,'quote'=>$verdict==='unknown'?'':($check['quote'] ?? ''),'reason'=>jobDisplayText((string)($check['reason'] ?? ''),300)];
    }
    $score=$possible>0 ? (int)round(100*$earned/$possible) : null;
    return ['score'=>$score,'eligible'=>!$reject && $score!==null && $score>=70,'checks'=>$reasons];
}

function jobFactFields(): array
{
    return [
        'company'=>['legal_name','address_line1','address_line2','postal_code','city','region','country_code','website','phone','email','industry','employee_count'],
        'contact'=>['first_name','last_name','position','department','email','phone','mobile','linkedin_url'],
        'job'=>['requirements','benefits','employment_type','engagement_type','contract_term','workplace_type','workload_min','workload_max','salary_min','salary_max','salary_currency','salary_period','country_code','external_id','fixed_term_start','fixed_term_end','published_at','expires_at'],
    ];
}
...
{
    $value=trim($value);
    if ($value==='' || !in_array($field,jobFactFields()[$entity] ?? [],true)) return null;
    $enums=[
        'employment_type'=>['full_time','part_time','temporary','contract','internship','freelance','other'],
        'engagement_type'=>['permanent','temporary'], 'contract_term'=>['open_ended','fixed_term'],
        'workplace_type'=>['onsite','hybrid','remote'], 'salary_period'=>['hour','month','year'],
    ];
    if (isset($enums[$field])) return in_array($value,$enums[$field],true) ? $value : null;
    if (in_array($field,['workload_min','workload_max'],true)) return ctype_digit($value) && (int)$value<=100 ? (int)$value : null;
    if (in_array($field,['salary_min','salary_max'],true)) return is_numeric($value) && (float)$value>=0 && (float)$value<=9999999999 ? (float)$value : null;
    if ($field==='country_code') return preg_match('/^[A-Z]{2}$/',$value) ? $value : null;
    if ($field==='salary_currency') return preg_match('/^[A-Z]{3}$/',$value) ? $value : null;
    if ($field==='email') return filter_var($value,FILTER_VALIDATE_EMAIL) ? $value : null;
    if (in_array($field,['website','linkedin_url'],true)) return filter_var($value,FILTER_VALIDATE_URL) && str_starts_with($value,'https://') ? $value : null;
    if (in_array($field,['fixed_term_start','fixed_term_end'],true)) {
        $date=DateTimeImmutable::createFromFormat('!Y-m-d',$value);
        return $date && $date->format('Y-m-d')===$value ? $value : null;
    }
    if (in_array($field,['published_at','expires_at'],true)) {
...
function applyJobEvidence(array $draft, array $response, array $criteria): array
{
    ...
    if (count($response['facts'] ?? [])>150) throw new RuntimeException('Zu viele extrahierte Angaben.');
    foreach ($response['facts'] ?? [] as $fact) {
        $entity=(string)($fact['entity'] ?? ''); $field=(string)($fact['field'] ?? '');
        $source=(string)($fact['source_id'] ?? ''); $quote=(string)($fact['quote'] ?? '');
        ...
        if ($entity==='job') $jobDetails[$field]=$value;
        if ($entity==='contact') {
            $person=trim((string)($fact['person'] ?? ''));
            if ($person==='') continue;
            $contacts[$source.'|'.$person][$field]=$value;
            $contacts[$source.'|'.$person]['_source']=$source;
        }
        $accepted[]=$fact;
    }
    foreach ($contacts as $contact) {
        if (empty($contact['first_name']) && empty($contact['last_name'])) continue;
        if (empty($contact['email']) && empty($contact['phone']) && empty($contact['mobile'])) continue;
        $role=(string)($contact['position'] ?? '').' '.(string)($contact['department'] ?? '');
        if ($contact['_source']!=='original' && !preg_match('/recruit|human resources|personal|ressources humaines|talent|\bHR\b/iu',$role)) continue;
        if (preg_match('/privacy|datenschutz|support|cookie/iu',$role.' '.($contact['email'] ?? ''))) continue;
        unset($contact['_source']); $draft['contacts'][]=$contact;
    }
    if (isset($jobDetails['workload_min'],$jobDetails['workload_max']) && $jobDetails['workload_min']>$jobDetails['workload_max']) unset($jobDetails['workload_min'],$jobDetails['workload_max']);
    if (isset($jobDetails['salary_min'],$jobDetails['salary_max']) && $jobDetails['salary_min']>$jobDetails['salary_max']) unset($jobDetails['salary_min'],$jobDetails['salary_max']);
    $draft['job_details']=$jobDetails;
    foreach (['published_at'=>'datePosted','expires_at'=>'validThrough'] as $field=>$schemaKey) {
        $date=(string)($draft['structured_job'][$schemaKey] ?? '');
        if (preg_match('/^\d{4}-\d{2}-\d{2}(?:T|$)/',$date) && ($timestamp=strtotime($date))!==false) $draft['job_details'][$field]=gmdate('Y-m-d H:i:s',$timestamp);
    }
    $draft['assessment']=jobEvidenceScore($criteria,(array)($response['checks'] ?? []),$sources);
    $draft['assessment']['revision']=1;
...
function jobStructuredResponse(array $config, int $uid, string $instructions, array $input, array $schema): array
{
    ...
    if ($key==='' || !function_exists('curl_init')) throw new RuntimeException('Die KI-Prüfung ist nicht verfügbar.');
    $payload=['model'=>$config['openai_model'] ?? 'gpt-5.6-luna','store'=>false,'reasoning'=>['effort'=>'low'],'max_output_tokens'=>6500,
        'safety_identifier'=>hash('sha256','jema-job-verification:'.$uid),'instructions'=>$instructions,
        'input'=>json_encode($input,JSON_THROW_ON_ERROR | JSON_UNESCAPED_UNICODE),
...
{
    $preference=dbOne($db,'SELECT * FROM user_preferences WHERE user_id=? AND is_active=1 ORDER BY id LIMIT 1','i',[$uid]) ?: [];
    $user=dbOne($db,'SELECT id, preferred_language, city, region, country_code FROM users WHERE id=?','i',[$uid]) ?: [];
    $criteria=savedJobSearchCriteria($db,$uid,$preference,$user,[]);
    $criteria['display_locale']=currentLocale($user);
    return $criteria;
}
...
function openAiJobSearch(array $config, int $userId, array $criteria): array
{
    ...
    $handle = curl_init('https://api.openai.com/v1/responses');
    curl_setopt_array($handle, [CURLOPT_POST=>true,CURLOPT_POSTFIELDS=>$payload,CURLOPT_HTTPHEADER=>['Authorization: Bearer '.$apiKey,'Content-Type: application/json'],CURLOPT_RETURNTRANSFER=>true,CURLOPT_CONNECTTIMEOUT=>10,CURLOPT_TIMEOUT=>180,CURLOPT_PROTOCOLS=>CURLPROTO_HTTPS,CURLOPT_REDIR_PROTOCOLS=>CURLPROTO_HTTPS]);
    $raw = curl_exec($handle); $status = (int) curl_getinfo($handle, CURLINFO_RESPONSE_CODE); $error = curl_error($handle); curl_close($handle);
    if (!is_string($raw) || $status < 200 || $status >= 300) {
        $apiError = '';
        if (is_string($raw)) { $errorBody = json_decode($raw, true); $apiError = trim((string) (($errorBody['error']['message'] ?? '') ?: ($errorBody['error']['code'] ?? ''))); }
        throw new RuntimeException('Die KI-Stellensuche ist fehlgeschlagen (HTTP ' . $status . ($apiError !== '' ? ': ' . substr($apiError, 0, 180) : ($error !== '' ? ': ' . $error : '')) . ').');
    }
    ...
    // Discovery only. No score or availability from this response is trusted.
    return array_slice($jobs, 0, $requested);
}

function visibleVerifiedJobs(array $jobs, array $criteria, int $now): array
{
    $hash=hash('sha256',json_encode(jobMatchCriteria($criteria),JSON_THROW_ON_ERROR));
...
function verifiedSearchScript(string $locale): string
{
    ...
    $resultLabels=match($locale) {
        'fr-CH'=>['Recherche réussie.','Aucune offre compatible trouvée.','La suite de la recherche a été interrompue.'],
        'en-GB'=>['Search successful.','No matching jobs found.','Further searching was interrupted.'],
        'pt-BR'=>['Busca bem-sucedida.','Nenhuma vaga compatível encontrada.','A continuação da busca foi interrompida.'],
        'es-MX'=>['Búsqueda exitosa.','No se encontraron empleos compatibles.','Se interrumpió la búsqueda adicional.'],
        default=>['Suche erfolgreich.','Keine passenden Jobs gefunden.','Die weitere Suche wurde unterbrochen.'],
    };
...
<script>
(()=>{
 const labels=__LABELS__, debugLabels=__DEBUG_LABELS__, resultLabels=__RESULT_LABELS__, button=document.querySelector('button[value="search_ai_jobs"]'), form=button?.closest('form');if(!form)return;
 ...
 form.querySelectorAll('input,textarea,select').forEach(field=>{field.addEventListener('input',()=>{clearTimeout(timer);timer=setTimeout(save,700);});field.addEventListener('change',()=>{clearTimeout(timer);save();});});
 let running=false;
 form.addEventListener('submit',async event=>{
  ...
  try{
   await saving;if(cancelled)return;
   const initial=new FormData(form);initial.set('action','search_ai_jobs');initial.set('incremental','1');const start=await send(initial);
   while(!cancelled){
...
HTML;
    return str_replace(['__LABELS__','__DEBUG_LABELS__','__RESULT_LABELS__'],[json_encode($labels,JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_QUOT | JSON_HEX_APOS | JSON_THROW_ON_ERROR),json_encode($debugLabels,JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_QUOT | JSON_HEX_APOS | JSON_THROW_ON_ERROR),json_encode($resultLabels,JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_QUOT | JSON_HEX_APOS | JSON_THROW_ON_ERROR)],$html);
}
...
function canonicalJobUrl(string $url): string
{
    ...
    foreach (array_keys($query) as $key) if (preg_match('/^utm_|^(track|tracking|ref|source)$/i',$key)) unset($query[$key]);
    ksort($query);
...
function advanceVerifiedJobSearch(array $config, int $uid, array &$state): void
{
    ...
    try {
        ...
        $state['jobs'][]=['company'=>$draft['company'],'location'=>$draft['location'],'title'=>$assessment['title'],'description'=>$assessment['summary'],
            'match_percent'=>$assessment['score'],'match_reason'=>$assessment['reason'],'url'=>$url,'original_url'=>$draft['original_url'],
            'verification_revision'=>1,'verified_at'=>time(),'criteria_hash'=>$assessment['criteria_hash'],
...
{
    $key = 'workflow_calendar_v5';
    if (dbOne($db, 'SELECT migration_key FROM app_migrations WHERE migration_key=?', 's', [$key])) { return; }
    if ((int)(dbOne($db, "SELECT GET_LOCK('jema-workflow-v5', 10) acquired")['acquired'] ?? 0) !== 1) {
        throw new RuntimeException('Workflow migration is already running');
    }
    try {
        if (dbOne($db, 'SELECT migration_key FROM app_migrations WHERE migration_key=?', 's', [$key])) { return; }
        $db->query("ALTER TABLE applications ALTER COLUMN job_room_registration SET DEFAULT 'not_recorded'");
        $db->begin_transaction();
        try {
            foreach (['applications' => 'user_id', 'calendar_events' => 'owner_user_id'] as $table => $ownerColumn) {
                $where = $table === 'applications' ? 'deleted_at IS NULL' : "source_type IS NOT NULL";
                foreach (dbAll($db, "SELECT * FROM {$table} WHERE {$where} FOR UPDATE") as $row) {
                    $payload = json_encode($row, JSON_UNESCAPED_UNICODE | JSON_THROW_ON_ERROR);
                    cascadeExec($db, 'INSERT IGNORE INTO workflow_data_backups (migration_key, entity_type, entity_id, owner_user_id, payload) VALUES (?, ?, ?, ?, ?)', 'ssiis', [$key, $table, (int)$row['id'], (int)$row[$ownerColumn], $payload]);
                }
            }
            // Only retain a waiting date when it is distinct from the automatic submission date.
            $db->query("UPDATE applications SET next_action_at=CASE
                WHEN next_action_at=applied_at THEN NULL ELSE next_action_at END
                WHERE deleted_at IS NULL AND next_action='await_response'");
            $db->query("UPDATE applications SET next_action=CASE WHEN next_action_at IS NOT NULL THEN 'follow_up' ELSE NULL END
                WHERE deleted_at IS NULL AND next_action='await_response'");
            $db->query("UPDATE calendar_events SET status='cancelled', completed_at=NULL
                WHERE source_type='application_next_action' AND status='completed'
                AND (source_key=CONCAT('completed-',id) OR source_key=CONCAT('closed-',id))");
            foreach (dbAll($db, 'SELECT id, user_id FROM applications WHERE deleted_at IS NULL ORDER BY id') as $row) {
                syncApplicationWorkflow($db, (int)$row['user_id'], (int)$row['id']);
            }
        ...
        dbOne($db, "SELECT RELEASE_LOCK('jema-workflow-v5') released");
    }
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'delete_calendar_event') {
        ...
        if ($deleteEvent && ($deleteEvent['entry_kind'] ?? '') !== 'milestone') {
            ...
            $stmt->execute();
            syncCalendarAutomatically($db, $config, $uid, $currentUser ?? []);
            audit($db, $uid, 'delete', 'calendar_event', $eventId, null, null);
            flash(tr('flash.calendar.deleted'));
        }
    ...
    if ($action === 'connect_google_calendar') {
        ...
        $calendarId = 'primary';
        $syncEnabled = 1;
        $stmt = $db->prepare('INSERT INTO user_google_calendar_settings (user_id, calendar_id, sync_enabled) VALUES (?, ?, ?) ON DUPLICATE KEY UPDATE calendar_id=VALUES(calendar_id), sync_enabled=VALUES(sync_enabled), updated_at=NOW()');
        $stmt->bind_param('isi', $uid, $calendarId, $syncEnabled);
        $stmt->execute();
    ...
    if ($action === 'select_google_calendar') {
        $uid = userId();
        ...
        try {
            $token = googleAccessToken($db, $config, $uid, $settings);
            $calendar = googleJsonRequest('GET', 'https://www.googleapis.com/calendar/v3/calendars/' . rawurlencode($calendarId), ['Authorization: Bearer ' . $token]);
            $calendarSummary = trim((string) ($calendar['summary'] ?? $calendarSummary));
        } catch (Throwable $ignored) {
            // Die Auswahl bleibt auch dann erhalten, wenn Google den Anzeigenamen nicht liefert.
        }
        $stmt = $db->prepare('UPDATE user_google_calendar_settings SET calendar_id=?, calendar_summary=?, sync_enabled=1, updated_at=NOW() WHERE user_id=?');
        $stmt->bind_param('ssi', $calendarId, $calendarSummary, $uid);
        $stmt->execute();
    ...
    if ($action === 'suggest_job_search_criteria') {
        try {
            ...
            $query = trim((string) ($_POST['search_query'] ?? ''));
            if ($query === '') {
                $queryParts = array_filter(array_map(static fn(string $value): string => trim($value), [(string) ($_POST['desired_roles'] ?? ''), (string) ($_POST['desired_level'] ?? ''), (string) ($_POST['employment_types'] ?? ''), (string) ($_POST['remote_preference'] ?? '')]));
                $query = implode(' ', $queryParts) ?: jobPreferenceQuery($preference);
            }
    ...
    if ($action === 'search_ai_jobs') {
        try {
            if (empty($_POST['incremental'])) throw new RuntimeException('Für die geprüfte Suche muss JavaScript aktiviert sein.');
            $preference = dbOne($db, 'SELECT * FROM user_preferences WHERE user_id=? AND is_active=1 ORDER BY id LIMIT 1', 'i', [userId()]) ?: [];
            $query = trim((string) ($_POST['search_query'] ?? ''));
            if ($query === '') {
                $queryParts = array_filter(array_map(static fn(string $value): string => trim($value), [(string) ($_POST['desired_roles'] ?? ''), (string) ($_POST['desired_level'] ?? ''), (string) ($_POST['employment_types'] ?? ''), (string) ($_POST['remote_preference'] ?? '')]));
            ...
            $_SESSION['ai_job_search_results']=[];
    ...
    if ($action === 'advance_verified_job_search') {
        ...
        try {
            ...
            http_response_code(422); echo json_encode(['ok'=>false,'accepted'=>$validSearch ? count($state['jobs']) : 0]);
        }
        exit;
    }
    ...
    if ($action === 'prepare_job_import' || $action === 'commit_job_import') {
        ...
        try {
            if ($action === 'prepare_job_import') {
                ...
                $draft=verifiedJobImport($config,userId(),$url,importSearchCriteria($db,userId())); // No CRM writes in preparation.
                ...
                $_SESSION['pending_job_imports']=$pending;
                if (($draft['assessment']['criteria_hash'] ?? '')!==hash('sha256',json_encode(jobMatchCriteria(importSearchCriteria($db,userId())),JSON_THROW_ON_ERROR))) throw new RuntimeException('Suchkriterien wurden geändert. Bitte erneut übernehmen.');
                if (($draft['availability']['expires_at'] ?? PHP_INT_MAX)<time()) throw new RuntimeException('Die Ausschreibung ist inzwischen abgelaufen.');
    ...
    if ($action === 'prepare_ai_job_import') {
        ...
        try {
            $saved = importStoreDraft($db, userId(), verifiedJobImport($config,userId(),$url,importSearchCriteria($db,userId())));
        } catch (Throwable $exception) {
    ...
    if ($action === 'exclude_ai_job') {
        $url = trim((string) ($_POST['job_url'] ?? ''));
        if (!filter_var($url, FILTER_VALIDATE_URL) || !str_starts_with($url, 'https://')) { http_response_code(422); exit('Invalid URL'); }
        $excluded=[canonicalJobUrl($url)=>true];
        foreach ((array)($_SESSION['ai_job_search_results'] ?? []) as $job) {
            if (canonicalJobUrl((string)($job['url'] ?? ''))===canonicalJobUrl($url) && !empty($job['original_url'])) $excluded[canonicalJobUrl($job['original_url'])]=true;
        }
        $uid=userId();
        foreach (array_keys($excluded) as $excludedUrl) {
            $stmt=$db->prepare('INSERT IGNORE INTO user_job_search_exclusions (user_id, job_url) VALUES (?, ?)');
            $stmt->bind_param('is',$uid,$excludedUrl); $stmt->execute();
        }
        $_SESSION['ai_job_search_results']=array_values(array_filter((array)($_SESSION['ai_job_search_results'] ?? []),static fn(array $job):bool=>!isset($excluded[canonicalJobUrl((string)($job['url'] ?? ''))]) && !isset($excluded[canonicalJobUrl((string)($job['original_url'] ?? ''))])));
        if (isset($_SESSION['verified_job_search'])) {
            $_SESSION['verified_job_search']['excluded']=array_merge($_SESSION['verified_job_search']['excluded'],$excluded);
            $_SESSION['verified_job_search']['jobs']=$_SESSION['ai_job_search_results'];
        }
    ...
    if ($action === 'preview_import') {
        ...
        if (count($importUrls) > 1 || (count($importUrls) === 1 && importPayloadIsUrlOnly($payload, $importUrls))) {
            ...
            foreach ($importUrls as $sourceUrl) {
                try {
                    $saved = importStoreDraft($db, $uid, verifiedJobImport($config,$uid,$sourceUrl,importSearchCriteria($db,$uid)));
    ...
    if ($action === 'save_profile_link') {
        ...
        $isLocalWindowsPath = preg_match('/^[A-Za-z]:\\\\(?:[^\\\\<>:"|?*]+\\\\)*[^\\\\<>:"|?*]*$/', $linkUrl) === 1;
        $isWindowsFileUrl = preg_match('/^file:\\/\\/?[A-Za-z]:[\\\\\/]/i', $linkUrl) === 1;
        if ($isWindowsFileUrl) {
            $linkUrl = str_replace('/', '\\\\', preg_replace('/^file:\\/\\/?/i', '', $linkUrl));
            $isLocalWindowsPath = true;
        }
        if ($linkName === '' || $linkUrl === '') {
            flash(tr('profile.link_required'), 'danger');
            redirect('/?page=profile_links');
        }
        if (!filter_var($linkUrl, FILTER_VALIDATE_URL) && !$isLocalWindowsPath && !$isWindowsFileUrl) {
    ...
    if ($action === 'bulk_delete_jobs') {
        $ids = array_values(array_unique(array_filter(array_map('intval', (array) ($_POST['job_ids'] ?? [])))));
        $uid = userId();
        $db->begin_transaction();
        try {
            foreach ($ids as $id) {
                $old = dbOne($db, 'SELECT id, company_id, title, location_text, status, workplace_type, source_url, SUBSTRING(description,1,65535) description FROM jobs WHERE id = ? AND owner_user_id = ? AND deleted_at IS NULL', 'ii', [$id, $uid]);
                if (!$old) {
                    continue;
                }
                cleanupJobCascade($db, $uid, $id);
                ...
                $stmt->bind_param('ii', $id, $uid);
                $stmt->execute();
                audit($db, $uid, 'delete', 'job', $id, $old, null);
            }
            $db->commit();
        } catch (Throwable $exception) {
            $db->rollback();
        ...
        if ($companyFilter > 0) {
            $returnUrl .= '&company_id=' . $companyFilter;
        }
        redirect($returnUrl);
    }
    ...
    if ($action === 'delete_contact') {
        ...
        $old = dbOne($db, 'SELECT id, company_id, first_name, last_name, email FROM contacts WHERE id=? AND owner_user_id=? AND deleted_at IS NULL', 'ii', [$contactId, $uid]);
        if ($old) {
            cleanupContactCascade($db, $uid, $contactId);
            $stmt = $db->prepare('UPDATE contacts SET deleted_at=NOW() WHERE id=? AND owner_user_id=?');
    ...
    if (in_array($action, ['save_application', 'autosave_application'], true)) {
        ...
        $jobRoomRegistration = in_array($_POST['job_room_registration'] ?? '', ['unknown','not_recorded','recorded'], true) ? (string)$_POST['job_room_registration'] : null;
        ...
        if ($isAutosave) {
            header('Content-Type: application/json; charset=utf-8');
            echo json_encode(['ok' => true, 'message' => tr('applications.autosave_saved'), 'applied_at' => $appliedAt, 'next_action' => $nextAction, 'next_action_at' => $nextActionAt], JSON_UNESCAPED_UNICODE);
            exit;
        }
    ...
    if ($action === 'submit_online_application') {
        ...
        $status = 'sent';
        $stmt = $db->prepare("UPDATE applications SET primary_contact_id=NULLIF(?,0), status=?, channel=?, applied_at=?,
            next_action_at=CASE WHEN next_action IN ('send_application','await_response') THEN NULL ELSE next_action_at END,
            next_action=CASE WHEN next_action IN ('send_application','await_response') THEN NULL ELSE next_action END,
            application_url=?, portal_account=?, reference_number=?, online_notes=?, cover_letter_text=?, notes=? WHERE id=? AND user_id=?");
        $stmt->bind_param('isssssssssii', $primaryContactId, $status, $channel, $appliedAt, $applicationUrl, $portalAccount, $referenceNumber, $onlineNotes, $coverLetter, $notes, $id, $uid);
        $stmt->execute();
    ...
    if ($action === 'send_application_email') {
        ...
        $recipient = $hasAssignedContact
            ...
            : strtolower(trim((string) ($_POST['recipient_email'] ?? '')));
        ...
        if ($sent) {
            ...
            $sentStatus = 'sent';
            $stmt = $db->prepare("UPDATE applications SET status=?, channel='email', applied_at=COALESCE(applied_at, ?),
                next_action_at=CASE WHEN next_action IN ('send_application','await_response') THEN NULL ELSE next_action_at END,
                next_action=CASE WHEN next_action IN ('send_application','await_response') THEN NULL ELSE next_action END,
                email_subject=?, email_body=? WHERE id=? AND user_id=?");
            $stmt->bind_param('ssssii', $sentStatus, $now, $subject, $body, $id, $uid);
            $stmt->execute();
            $oldStatus = (string) $application['status'];
...
if ($page === 'export_csv') {
    ...
    $rows = dbAll($db, 'SELECT j.id, j.title, c.name company, j.location_text, j.status, j.workplace_type, j.created_at, j.updated_at FROM jobs j JOIN companies c ON c.id=j.company_id WHERE j.owner_user_id=? AND j.deleted_at IS NULL ORDER BY j.updated_at DESC', 'i', [userId()]);
...
if ($page === 'export_pdf') {
    ...
    $workplaceTypes = workplaceTypeOptions();
    $rows = dbAll($db, 'SELECT j.id, j.title, c.name company, j.location_text, j.status, j.workplace_type, j.created_at, j.updated_at FROM jobs j JOIN companies c ON c.id=j.company_id WHERE j.owner_user_id=? AND j.deleted_at IS NULL ORDER BY j.updated_at DESC', 'i', [userId()]);
    pdfResponse('jobs.pdf', tr('nav.jobs'), [tr('jobs.recorded_at'),tr('common.title'),tr('companies.company'),tr('jobs.location'),tr('common.status'),tr('jobs.workplace_type'),tr('common.updated')], array_map(static fn(array $r): array => [displayDateTime($r['created_at'], $currentUser, false),$r['title'], $r['company'], $r['location_text'], optionLabel($jobStatuses, $r['status']), optionLabel($workplaceTypes, $r['workplace_type']), $r['updated_at']], $rows));
}
...
<header class="topbar <?= $supportGrant ? 'topbar-support-granted' : '' ?> <?= $supportImpersonating ? 'topbar-support-admin' : '' ?>">
    ...
    <?php if ($currentUser): ?>
        ...
        <nav class="menubar" aria-label="<?= e(tr('nav.menu')) ?>">
            <div class="menu-group"><button type="button" class="menu-trigger"><?= e(tr('nav.file')) ?></button><div class="menu-panel"><a href="/?page=dashboard"><?= e(tr('nav.dashboard')) ?></a><div class="submenu"><button type="button"><?= e(tr('nav.master_data')) ?></button><div class="submenu-panel"><a href="/?page=profile"><?= e(tr('nav.profile')) ?></a><a href="/?page=documents"><?= e(tr('nav.documents')) ?></a><a href="/?page=profile_links"><?= e(tr('profile.links_title')) ?></a><a href="/?page=translations"><?= e(tr('nav.translations')) ?></a></div></div><a href="/?page=privacy"><?= e(tr('nav.privacy')) ?></a><a href="/?page=audit"><?= e(tr('nav.audit')) ?></a></div></div>
...
<?php else: requireLogin(); ?>
    ...
    <?php elseif ($page === 'calendar'): ?>
        ...
        <?php elseif(in_array($calendarView, ['day','workweek','week'], true)): ?>
            ...
            <h2><?= e($calendarView==='day' ? tr('calendar.day_plan') : ($calendarView==='workweek' ? tr('calendar.workweek_plan') : tr('calendar.week_plan'))) ?> · <?= e(tr('calendar.week_number_short')) ?> <?= e($weekNo) ?></h2><div class="time-grid" style="--day-count:<?= count($days) ?>;--matrix-min:<?= count($days) === 1 ? '520px' : (count($days) === 5 ? '980px' : '1180px') ?>"><div class="time-head"></div><?php foreach($days as $day): ?><div class="time-day-head<?= $day->format('Y-m-d') === $calendarToday ? ' is-today' : '' ?>"<?= $day->format('Y-m-d') === $calendarToday ? ' aria-current="date"' : '' ?>><?= e(($weekdayNames[$day->format('D')] ?? $day->format('D')) . ', ' . $day->format('d.m.')) ?></div><?php endforeach; ?><div class="time-all-day-label"><?= e(tr('calendar.all_day')) ?></div><?php foreach($days as $day): $dateKey=$day->format('Y-m-d'); $dayEntries=array_values(array_filter($eventsByDate[$dateKey] ?? [], $isDayEntry)); ?><div class="time-all-day-cell<?= $dateKey === $calendarToday ? ' is-today' : '' ?>"><a class="calendar-add" href="<?= e($newEntryUrl($dateKey.'T00:00')) ?>">+</a><?php foreach($dayEntries as $event): ?><?= $renderEvent($event, false) ?><?php endforeach; ?></div><?php endforeach; ?><?php foreach($hours as $hour): ?><div class="time-slot"><?= sprintf('%02d:00', $hour) ?></div><?php foreach($days as $day): $dateKey=$day->format('Y-m-d'); $slotStart=$dateKey.'T'.sprintf('%02d:00',$hour); $hourEvents=array_values(array_filter($eventsByDate[$dateKey] ?? [], static fn(array $ev): bool => date('H:i:s', strtotime((string)$ev['starts_at'])) !== '00:00:00' && (int)date('G', strtotime((string)$ev['starts_at'])) === $hour)); ?><div class="time-cell<?= $dateKey === $calendarToday ? ' is-today' : '' ?>"><a class="calendar-add" href="<?= e($newEntryUrl($slotStart)) ?>">+</a><?php foreach($hourEvents as $event): ?><?= $renderEvent($event) ?><?php endforeach; ?></div><?php endforeach; ?><?php endforeach; ?></div>
        <?php elseif($calendarView === 'month'): ?>
            <?php $monthStart=$rangeStart; $monthEnd=$rangeEnd; $monthDays=[]; for($d=$monthStart; $d <= $monthEnd; $d=$d->modify('+1 day')) { $monthDays[]=$d; } ?>
            <h2><?= e(tr('calendar.month_plan')) ?> <?= e($anchor->format('m.Y')) ?></h2><div class="month-grid"><div class="month-week-head"><?= e(tr('calendar.week_number_short')) ?></div><?php foreach([tr('weekday.mon_short'),tr('weekday.tue_short'),tr('weekday.wed_short'),tr('weekday.thu_short'),tr('weekday.fri_short'),tr('weekday.sat_short'),tr('weekday.sun_short')] as $wd): ?><div class="month-day-head"><?= e($wd) ?></div><?php endforeach; ?><?php foreach(array_chunk($monthDays,7) as $week): ?><div class="month-week-no"><?= e($week[0]->format('W')) ?></div><?php foreach($week as $day): $dateKey=$day->format('Y-m-d'); ?><div class="month-day <?= $day->format('m')===$anchor->format('m')?'':'is-muted' ?><?= $dateKey === $calendarToday ? ' is-today' : '' ?>"<?= $dateKey === $calendarToday ? ' aria-current="date"' : '' ?>><div class="month-day-top"><strong><?= e($day->format('d.m.')) ?></strong><a class="calendar-add" href="<?= e($newEntryUrl($dateKey.'T09:00')) ?>">+</a></div><?php foreach(($eventsByDate[$dateKey] ?? []) as $event): ?><?= $renderEvent($event, !$isDayEntry($event)) ?><?php endforeach; ?></div><?php endforeach; ?><?php endforeach; ?></div>
        <?php endif; ?>
    ...
    <?php elseif ($page === 'profile_links'): ?>
        ...
        ?>
        <div class="page-head"><div><p class="eyebrow"><?= e(tr('profile.master_data')) ?></p><h1><?= e(tr('profile.links_title')) ?></h1></div></div>
        <div class="split"><section class="panel"><h2><?= e($editProfileLink ? tr('profile.link_save') : tr('profile.link_create')) ?></h2><form method="post" class="stack"><input type="hidden" name="csrf" value="<?= csrfToken() ?>"><input type="hidden" name="link_id" value="<?= (int) ($editProfileLink['id'] ?? 0) ?>"><label><?= e(tr('profile.link_name')) ?><input name="link_name" value="<?= e($editProfileLink['link_name'] ?? '') ?>" required></label><label><?= e(tr('profile.link_url')) ?><input name="link_url" value="<?= e($editProfileLink['link_url'] ?? '') ?>" placeholder="https://... oder C:\\Ordner\\Datei" required></label><div class="actions"><button class="primary" name="action" value="save_profile_link"><?= e($editProfileLink ? tr('profile.link_save') : tr('profile.link_create')) ?></button><?php if($editProfileLink): ?><a class="button" href="/?page=profile_links"><?= e(tr('common.cancel')) ?></a><?php endif; ?></div></form></section><section class="panel table-wrap"><table><thead><tr><th><?= e(tr('profile.link_name')) ?></th><th><?= e(tr('profile.link_url')) ?></th><th><?= e(tr('common.actions')) ?></th></tr></thead><tbody><?php foreach($profileLinks as $profileLink): $isLocalProfileLink = preg_match('/^[A-Za-z]:\\\\/', (string) $profileLink['link_url']) === 1; $profileLinkHref = $isLocalProfileLink ? 'file:///' . str_replace('\\\\', '/', (string) $profileLink['link_url']) : (string) $profileLink['link_url']; ?><tr><td><?= e($profileLink['link_name']) ?></td><td><a href="<?= e($profileLinkHref) ?>" target="_blank" rel="noopener noreferrer"><?= e($profileLink['link_url']) ?></a></td><td class="actions"><a href="/?page=profile_links&edit_profile_link=<?= (int)$profileLink['id'] ?>"><?= e(tr('common.edit')) ?></a><form method="post"><input type="hidden" name="csrf" value="<?= csrfToken() ?>"><input type="hidden" name="link_id" value="<?= (int)$profileLink['id'] ?>"><button name="action" value="delete_profile_link"><?= e(tr('common.delete')) ?></button></form></td></tr><?php endforeach; ?><?php if(!$profileLinks): ?><tr><td colspan="3" class="empty"><?= e(tr('profile.link_empty')) ?></td></tr><?php endif; ?></tbody></table></section></div>
    ...
    <?php elseif ($page === 'job_platform_search'): ?>
        ...
        $aiJobResults = visibleVerifiedJobs(is_array($_SESSION['ai_job_search_results'] ?? null) ? $_SESSION['ai_job_search_results'] : [],$searchCriteria,time());
        $translationError = '';
        try {
        ...
        $aiResultLabels = match ($appLocale) {
            ...
            'es-MX' => ['take'=>'Importar','match'=>'Coincidencia','company'=>'Empresa','location'=>'Lugar de trabajo','title'=>'Título del puesto','description'=>'Descripción breve','link'=>'Enlace de la vacante','open'=>'Abrir vacante','empty'=>'Aún no se buscaron vacantes adecuadas.'],
            default => ['take'=>'Übernehmen','match'=>'Match','company'=>'Firma','location'=>'Arbeitsort','title'=>'Jobbezeichnung','description'=>'Kurzbeschreibung','link'=>'Link zur Ausschreibung','open'=>'Ausschreibung öffnen','empty'=>'Noch keine passenden Jobs gesucht.'],
        };
        ?>
    ...
    <?php elseif ($page === 'applications'): ?>
        ...
        if ($applicationEdit && (int) ($applicationEdit['primary_contact_id'] ?? 0) > 0) {
            foreach ($contacts as $candidateContact) {
                if ((int) $candidateContact['id'] === (int) $applicationEdit['primary_contact_id']) {
                    $primaryContact = $candidateContact;
                    break;
                }
            }
        }
        ...
        <section class="panel application-editor" id="application-form">
            ...
            <form method="post" class="stack" id="application-edit-form" data-application-autosave data-autosave-idle="<?= e(tr('applications.autosave_hint')) ?>" data-autosave-saving="<?= e(tr('applications.autosave_saving')) ?>" data-autosave-saved="<?= e(tr('applications.autosave_saved')) ?>" data-autosave-error="<?= e(tr('applications.autosave_error')) ?>">
                ...
                <div class="job-room-compact" role="group" aria-label="<?= e(tr('applications.job_room_status')) ?>">
                    ...
                    <label><input type="checkbox" data-job-room-recorded <?= $registration==='recorded'?'checked':'' ?> onchange="this.form.elements.job_room_registration.value=this.checked?'recorded':'not_recorded';this.closest('.job-room-compact').querySelector('.job-room-details').hidden=!this.checked"> <?= e(tr('applications.job_room_recorded')) ?></label>
                    <span class="job-room-details" <?= $registration==='recorded'?'':'hidden' ?>>
    ...
    <?php elseif ($page === 'contacts'): ?>
        ...
        $contactSfFields = ['name'=>['label'=>tr('contacts.contact'),'expr'=>'CONCAT(ct.last_name, " ", ct.first_name)'], 'company'=>['label'=>tr('companies.company'),'expr'=>'c.name'], 'reachable'=>['label'=>tr('contacts.reachable'),'expr'=>'CONCAT_WS(" ", ct.email, ct.phone, ct.mobile)'], 'crm'=>['label'=>tr('contacts.activity_links'),'expr'=>'CONCAT_WS(" ", j.title, a.status)']];
