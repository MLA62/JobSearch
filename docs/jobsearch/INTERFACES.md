...
- `function jobRoomApplicationStatus(?string $result, ?string $applicationStatus, ?string $registration, ?string $appliedAt, bool $hasInterview = false): string`
