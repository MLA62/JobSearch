...
Offen: neuer angemeldeter Suchlauf. Die vorhandenen Schutzgrenzen können weiterhin vor vollständiger Quellenausschöpfung greifen; dies wird als begrenzt angezeigt. KI-Interpretation bleibt modellabhängig. Kein zusätzlicher Browser-Host, kein bezahlter Render-Dienst.
...
Vor dem Vorschlag bestätigte der Remote-Hash den unveränderten Stand 2.0.8. Freigegebene Schreibaktion ausgeführt am 2026-09-04T17:15:08+00:00. Danach Remote-Datei mit 990795 Bytes, Modus 0644 und identischem SHA-256 bestätigt. Keine Konfiguration oder DB-Dateien im Upload.

Öffentliche Loginseite: HTTP 200, Version 2.0.9 und Loginformular vorhanden, keine sichtbaren PHP-Fatal-/Parse-/Uncaught-Fehler. Anonymer Diagnoseabruf liefert Login-HTML, keinen JSON-Bericht. Kein authentifizierter KI-Suchlauf ausgeführt; dieser fachliche Nachweis bleibt offen.
