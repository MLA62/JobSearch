...
- Stand Version `1.15.20`: UI-Texte werden im Laufzeitpfad ueber DB-Keys
  gelesen. PHP- und Resource-Dateien duerfen keine Uebersetzungswoerterbuecher
  mehr enthalten.
- Stand Version `1.15.20`: PDF-Ausgaben uebersetzen Titel, Tabellenkoepfe,
  Zeilenwerte und Standard-Metatexte ueber dieselbe DB-Phrasenlogik.
- Stand Version `1.15.20`: `tr()` liest UI-Texte aus den Tabellen
