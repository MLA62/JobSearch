...
Stand: 04.09.2026. Version 2.1.1 mit einheitlichem KI-Arbeitsdialog und geschätzter App-Kontingentanzeige ist zur Freigabe vorbereitet.
Aktueller Nachweis: [Release 2.1.1](docs/jobsearch/RELEASE-2.1.1.md). Vorheriger bestätigter Live-Stand: [2.1.0](docs/jobsearch/RELEASE-2.1.0.md).
