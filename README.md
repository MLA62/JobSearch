...
Stand: 04.09.2026. Version 2.1.4 mit eindeutiger Neuerstellungs-/Überarbeitungslogik für KI-Bewerbungstexte ist zur Bereitstellung vorbereitet.
Aktueller Kandidat: [Release 2.1.4](docs/jobsearch/RELEASE-2.1.4.md). Bestätigter Live-Stand vor dieser Bereitstellung: [2.1.3](docs/jobsearch/RELEASE-2.1.3.md).
