...
Stand: 04.09.2026. Version 2.1.3 mit mobil zuverlässiger KI-Textaktion und vor dem Aufruf sichtbarem Arbeitsdialog ist deployed.
Aktueller Nachweis: [Release 2.1.3](docs/jobsearch/RELEASE-2.1.3.md). Vorheriger bestätigter Live-Stand: [2.1.2](docs/jobsearch/RELEASE-2.1.2.md).
