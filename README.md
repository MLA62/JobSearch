...
Stand: 07.09.2026. Version 2.1.8 mit soft-delete-sicherer Neuanlage, FK-sicherer Indexmigration und aussagekräftigen Fehlermeldungen ist zur Bereitstellung vorbereitet.
Aktueller Kandidat: [Release 2.1.8](docs/jobsearch/RELEASE-2.1.8.md). Bestätigter Live-Stand vor dieser Bereitstellung: [2.1.6](docs/jobsearch/RELEASE-2.1.6.md).
