...
Stand: 04.09.2026. Version 2.0.10 deployed; Serverdatei, öffentliche Versionsanzeige und anonyme Downloadsperre verifiziert. Angemeldete Prüfung des Quellenwechsels noch offen.
Aktueller Nachweis: [Release 2.0.10](docs/jobsearch/RELEASE-2.0.10.md). Vorheriger Live-Stand: [2.0.9](docs/jobsearch/RELEASE-2.0.9.md).
