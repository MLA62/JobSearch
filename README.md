...
Stand: 07.09.2026. Version 2.2.0 ergänzt sichere HTML-Mehrzeilenfelder mit Mini-Editor und chronologische Aktivitäten/Logs; das Deployment ist vorbereitet.
Bestätigter Live-Stand: [Release 2.1.9](docs/jobsearch/RELEASE-2.1.9.md). Nächster Stand: [Release 2.2.0](docs/jobsearch/RELEASE-2.2.0.md).
