...
Stand: 07.09.2026. Version 2.2.1 priorisiert bewusst manuell eingegebene Inserat-Adressen beim Schnellimport; das Deployment ist vorbereitet.
Bestätigter Live-Stand: [Release 2.2.0](docs/jobsearch/RELEASE-2.2.0.md). Nächster Stand: [Release 2.2.1](docs/jobsearch/RELEASE-2.2.1.md).
