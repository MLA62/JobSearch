...
Stand: 07.09.2026. Version 2.2.0 ergänzt sichere HTML-Mehrzeilenfelder mit Mini-Editor und chronologische Aktivitäten/Logs und ist bereitgestellt.
Bestätigter Live-Stand: [Release 2.2.0](docs/jobsearch/RELEASE-2.2.0.md).
